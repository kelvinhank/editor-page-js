...
export default defineConfig({
  resolve: {
    alias: {
      ...
      'suma-editor-base': path.resolve('../packages/suma-editor-base'),
      'suma-editor': path.resolve('../packages/suma-editor'),
      'suma-editor-extensions': path.resolve('../packages/suma-editor-extensions'),
    },
  },
  optimizeDeps: {},
  define: {},
