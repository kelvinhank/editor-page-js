...
import { BasicType, getParentIdx, getSiblingIdx } from 'suma-editor-base';
import { useBlock, useFocusIdx, useEditorProps, isTextBlock } from 'suma-editor';
...
export function Toolbar() {
  ...
  return (
    <>
      <div
        id='suma-editor-extensions-InteractivePrompt-Toolbar'
        style={{
          height: 0,
